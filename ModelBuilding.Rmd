...
# UniGramTable <- postClean(UniGramTable)
# UniGramTable <- UniGramTable[!(is.na(UniGramTable$LastTerm) | UniGramTable$LastTerm == "")]
# BiGramTable <- postClean(BiGramTable)
# BiGramTable <- BiGramTable[!(is.na(BiGramTable$LastTerm) | BiGramTable$LastTerm == "")]
# BiGramTable <- BiGramTable[!(is.na(BiGramTable$FirstTerms) | BiGramTable$FirstTerms == "")]
# TriGramTable <- postClean(TriGramTable)
# TriGramTable <- TriGramTable[!(is.na(TriGramTable$LastTerm) | TriGramTable$LastTerm == "")]
# TriGramTable <- TriGramTable[!(is.na(TriGramTable$FirstTerms) | TriGramTable$FirstTerms == "")]

BiGramTable[,term:=NULL]
TriGramTable[,term:=NULL]
# 
...
pred <- getTriGramProb("arctic monkeys this")


quiz = TriGramTable[grepl(pattern = paste0(c("Adam"),collapse = "|"),
