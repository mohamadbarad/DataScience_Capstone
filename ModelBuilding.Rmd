...
SampleData <- sapply(list(sample(linesInFile.blog,length(linesInFile.blog)*0.001),
                          sample(linesInFile.news,length(linesInFile.news)*0.001),
                          sample(linesInFile.twitter,length(linesInFile.twitter)*0.001)),
                     rbind)
...
DataSummary <- data.frame(Document = c("blog","news","twitter"), 
          ...
          Sampled0.1 = c(length(linesInFile.blog)*0.001,
                                     length(linesInFile.news)*0.001,
                                     length(linesInFile.twitter)*0.001)  )
DataSummary

# Saving data samples in RDS
saveRDS(SampleData, "SampleDataTinyList.rds")
...
# Reading data
data <- readRDS("SampleDataTinyList.rds")
