...
QuadGramTable <- readRDS("01OutComesObj/Without Stopwords/QuadGramTable.rds")
...
average_frequency("hadn't time take picture")

pred <- getTriGramProb("arctic monkeys this month")
